...
<div class="doc-page tpl-gst <?= $lang === 'ta' ? 'lang-ta' : '' ?>" style="<?= $idx > 0 ? 'margin-top:40px; page-break-before:always;' : '' ?>">
  ...
  <div class="doc-header">
    ...
    <div class="doc-title-block">
      <div class="doc-doctype"><?= !empty($custom_header_title) ? h($custom_header_title) : t('proforma_invoice', $lang) ?></div>
      <div class="doc-meta-row"><b><?= t('quotation_no', $lang) ?>:</b> <?= h($q['number']) ?></div>
      <div class="doc-meta-row"><b><?= t('date', $lang) ?>:</b> <?= h($q['date']) ?></div>
      <div class="doc-meta-row"><b>Place of Supply:</b> <?= h($clientState) ?> (<?= $interState ? 'Inter-State' : 'Intra-State' ?>)</div>
    </div>
  </div>
  ...
  <table class="doc-table tax-summary" style="margin-top:14px; width:60%; margin-left:auto;">
    <thead>
      <tr>
        <th><?= t('tax', $lang) ?></th>
...
<?php if (!empty($custom_footer_content)): ?>
  <div class="doc-note" style="margin-top:20px;"><?= nl2br(h($custom_footer_content)) ?></div>
<?php else: ?>
